module github.com/karamble/402sellerkit/rails/x402usdc

go 1.26.2

require (
	github.com/karamble/402sellerkit v0.0.0-00010101000000-000000000000
	github.com/x402-foundation/x402/go/v2 v2.17.0
)
...
// The 402sellerkit core is an unpublished sibling module in this monorepo;
